export const porkSkewers = {
  ...
  inspiration: "Shorlog",
  quantity: "10 skewers",
  time: "45 minutes, plus 1-24 hours of marinating",
  notes:
    "This was served at Roshone's manor, who we know clung to old Alethi ways, even when no longer popular. (The Way of Kings ch 25) To try and show that in the meal, I looked to Mongolian dishes and found Shorlog. Shorlog is basically barbecue - meat cooked on skewers over a fire. The legend goes that Mongolian warriors would cook their meat on their shields or with their swords. I could see a similar tradition for the Alethi - semi-nomadic warriors, eating meat on the go. I included vegetables as well since they were mentioned in the text.",
  quotes:
  ...
  ingredientSections: [
    {
      ...
      ingredients: [
        ...
        {
          item: "pork",
          display: "4 lbs pork loin"
        },
        {
          item: "bellPepper",
          display: "3 orange or red bell peppers"
        },
        {
          item: "summerSquash",
          display: "2 yellow squash"
        },
        {
          item: "flatbread",
          display:
            "flatbread, such as 1 recipe Tallew Flatbread or corn tortillas"
        }
      ]
    },
    {
      ...
      ingredients: [
        {
          item: "oysterSauce",
          display: "2 tbsp oyster sauce"
        },
        {
          item: "vinegar",
          display: "1 tbsp rice vinegar (unseasoned)"
        },
        {
          item: "garlicClove",
          display: "1 clove garlic, minced"
        },
        {
          item: "gochugaru",
          display: "1/2 tbsp gochugaru"
        },
        {
          item: "water",
          display: "1 tbsp water"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      ingredients: [
        ...
        {
          item: "ginger",
          display: "1/2 inch ginger"
        },
        {
          item: "curryPaste",
          display: "2 tsp yellow curry paste"
        },
        {
          item: "salt",
        ...
        {
          item: "coconut",
          display: "1/4 cup coconut milk"
        },
        {
          item: "water",
          display: "1/4 cup water"
        },
        {
          item: "gochugaru",
          display: "1 tbsp gochugaru"
        }
      ]
    },
    {
  ...
  steps: [
    ...
    "Oil sauce: Melt the coconut oil over medium low heat. Whisk in the rice vinegar. Whisk in the mustard powder. This will help keep the sauce from separating - whisk again when it starts to separate.",
    "Spicy sauce: Dice the onion, and peel and mince the ginger and garlic. Heat the oil in a pan over medium high heat, then add the onion, garlic, and ginger, and cook until the onion is transparent but not browned, about 5 minutes. Add the curry paste and salt. Cook and stir until combined. Add the coconut milk, water, and gochugaru. Cook and stir an additional 2 minutes.",
    "Fruit sauce: Remove the pit from the plum. Finely chop the plum or process it in a food processor. Peel and mince the ginger. Add both to a saucepan along with the other ingredients. Simmer on medium, covered, stirring occasionally, until everything comes together and forms a sauce, about 10 minutes.",
