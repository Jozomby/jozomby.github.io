export const rocksStew = {
  ...
  steps: [
    ...
    "Heat the oven to 425 degrees Fahrenheit, then return the baking sheet (with the vegetables on it) to the oven. Roast 20 minutes, stir thee vegetables, and roast another 10 minutes. Remove from the oven and set aside.",
