...
export const chouta = {
  ...
  quotes:
    'It seemed to be chunks of undefinable meat slathered in some dark liquid, all wrapped in overly thick bread. (Words of Radiance, ch 18)  Look. He’s frying that bread. "You fry the flangria too," Lopen said. "Make little balls of it, mixed with ground lavis. Batter it up and fry it, then stuff it in fried bread and pour on gravy. (Words of Radiance, ch 46)',
  image: "https://jozomby-public.s3.amazonaws.com/recipes/chouta-overview.jpg",
  ingredientSections: [
    {
      title: "Gravy",
      ingredients: [
        ...
        {
          item: "water",
          display: "2 1/2 cups water, divided"
        },
        {
          item: "oysterSauce",
        ...
        {
          item: "cornStarch",
          display: "3 tbsp corn starch"
        }
      ]
    },
    {
      title: "Flangria (meatballs)",
      ingredients: [
        {
          item: "spam",
          display: "1 12 oz. can low sodium luncheon meat (Spam)"
        },
        {
          item: "garlicClove",
        ...
        {
          item: "maseca",
          display: "1 1/4 cup mexican-style corn flour (Maseca), divided"
        },
        {
          item: "water",
          display: "1 cup water"
    ...
    {
      title: "Cremling claws (soft shell crabs)",
      ingredients: [
        {
          item: "softShellCrab",
          display: "5 soft shell crabs"
        },
        {
          item: "maseca",
          display: "1 cup mexican-style corn flour (Maseca), divided"
        },
        {
          item: "water",
          display: "1 cup water"
    ...
    },
    {
      ...
      ingredients: [
        ...
        {
          item: "water",
          display: "1 1/2 cups water, plus additional as needed"
        },
        {
          item: "vegetableOil",
          display: "vegetable oil for frying"
  ...
  steps: [
    ...
    "Meanwhile, for the flangria option, combine the Spam, 2 cloves garlic, 1/2 onion, 1/2 tsp coriander and 1/2 tsp cumin in a food processor. Process until combined. Knead in 3/4 cup Maseca. Form into 1 inch balls. Set aside.",
    "For the cremling claws option, defrost and clean 4 shoft shell crabs. Rinse the crabs, then pat dry. Dip in 1/2 cup Maseca to coat.",
    "For both flangria and cremling claws options, combine 1/2 cup maeca and 1 cup water to form a batter. Coat the flanggria balls or crabs in batter, then deep fry at 350 derees farenheit. Flangria - fry gently. If they lose their coating they'll fall apart. Cook until golden brown. Cremling claws - fry, flipping a few times, until golden on both sides.",
    ...
    "Form 1/2 cup of dough into a ball. Place between two sheets of parchment paper, then roll into a 8 inch circle. Cook on a griddle or dry pan over meedium high heat, flipping once. Both sides should have just a couple spots of brown. Repeat with the rest of the dough.",
