export const lavisPastrySquares = {
  id: "lavisPastrySquares",
  link: "/#/recipes/recipes/lavisPastrySquares",
  name: "Lavis Pastry Squares",
  cuisine: "Alethi",
  summary: "Crispy pastry squares for use with other recipes",
  inspiration: "American Piecrust",
  quantity: "About 32 squares",
  time: "30 minutes",
  notes:
    "We know that the Alethi eat pastries (Oathbringer ch 69). Unfortunately we don't get any more detail than that. So I experimented a bit with Mexican-style cornflour to see what kinds of pastry dough I could make without gluten. This one turned out basically the same as the full puff-pastry method I tried, but this is much easier and faster.",
  quotes:
    "I hear they've got storming good pastries at those fancy lighteyes parties. (Oathbringer ch 69)",
  image:
    "https://jozomby-public.s3.amazonaws.com/recipes/lavis-pastry-squares-overview.jpg",
  ingredientSections: [
    {
      title: null,
      ingredients: [
  ...
  steps: [
    ...
    "Use the pastry squares in the Simberries and Cream Pastry recipe or the Nuts and Honey Pastry recipe."
  ]
}
